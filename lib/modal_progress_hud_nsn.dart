...
// class modal_progress_hud_nsn extends StatelessWidget {
//   @override
...
class modal_progress_hud_nsn extends StatefulWidget {
  final VoidCallback _onSignIn;

  modal_progress_hud_nsn({required onSignIn})
...
class _LoginPageState extends State<modal_progress_hud_nsn> {
